 ...
 */
final class Version20220724124620 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE recipe (id INT AUTO_INCREMENT NOT NULL, cuisine_id INT NOT NULL, user_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, nb_people INT DEFAULT NULL, prep_time INT DEFAULT NULL, cooking_time INT DEFAULT NULL, ingredient LONGTEXT NOT NULL, step LONGTEXT NOT NULL, picture_one VARCHAR(255) DEFAULT NULL, picture_two VARCHAR(255) DEFAULT NULL, picture_three VARCHAR(255) DEFAULT NULL, picture_four VARCHAR(255) DEFAULT NULL, INDEX IDX_DA88B137ED4BAC14 (cuisine_id), INDEX IDX_DA88B137A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
